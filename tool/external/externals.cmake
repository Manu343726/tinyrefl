...
if(NOT TINYREFL_JINJA2CPP_VERSION)
    set(TINYREFL_JINJA2CPP_VERSION fc24a0b63fec8f1f23177da41fb832531d61b104) # Master commit as of 16/12/18
endif()
...
if(NOT TINYREFL_STRING_VIEW_LITE_URL)
    set(TINYREFL_STRING_VIEW_LITE_URL "https://github.com/martinmoene/string-view-lite")
endif()
if(NOT TINYREFL_STRING_VIEW_LITE_VERSION)
    set(TINYREFL_STRING_VIEW_LITE_VERSION v1.1.0)
endif()

external_dependency(fmt ${TINYREFL_FMT_REPO_URL} ${TINYREFL_FMT_VERSION})
...
external_dependency(string-view-lite ${TINYREFL_STRING_VIEW_LITE_URL} ${TINYREFL_STRING_VIEW_LITE_VERSION})
