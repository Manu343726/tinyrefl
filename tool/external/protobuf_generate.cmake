...
function(protobuf_generate)
    ...
    if(protobuf_generate_EXPORT_MACRO AND protobuf_generate_LANGUAGE STREQUAL
        ...
        set(_dll_export_decl
            "dllexport_decl=${protobuf_generate_EXPORT_MACRO}:")
    endif()
    ...
    foreach(_proto ${protobuf_generate_PROTOS})
        ...
        add_custom_command(
            ...
            COMMENT
                "Running ${protobuf_generate_LANGUAGE} protocol buffer compiler on ${_proto}. Custom options: ${protobuf_generate_PROTOC_OPTIONS}"
            VERBATIM)
    endforeach()
