...
if(TINYREFL_TOOL_USING_CONAN_TARGETS)
    ...
    target_link_libraries(tinyrefl_externals_protobuf     INTERFACE CONAN_PKG::protobuf)
    ...
    if(NOT protobuf_FOUND)
        ...
        external_dependency(protobuf ${TINYREFL_PROTOBUF_URL} ${TINYREFL_PROTOBUF_VERSION} SOURCE_SUBDIR cmake)
        ...
        message(STATUS "tinyrefl-tool build using protobuf from find_package() module")

        add_library(tinyrefl_externals_protobuf INTERFACE)
        target_link_libraries(tinyrefl_externals_protobuf INTERFACE protobuf::libprotobuf)
    endif()
endif()
