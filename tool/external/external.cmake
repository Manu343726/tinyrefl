...
if(NOT TINYREFL_FMT_VERSION)
    set(TINYREFL_FMT_VERSION 5.3.0)
endif()
...
if(NOT TINYREFL_SPDLOG_VERSION)
    set(TINYREFL_SPDLOG_VERSION v1.3.1)
endif()
...
if(TINYREFL_TOOL_USING_CONAN_TARGETS)
        ...
        if(TINYREFL_USE_LOCAL_LLVM)
            ...
            if(NOT TINYREFL_LLVM_DOWNLOAD_URL)
                if(TINYREFL_LLVM_DOWNLOAD_FROM_OFFICIAL_SERVER)
                    ...
                    message(STATUS "Using default LLVM download url from mirror")
                    set(TINYREFL_LLVM_DOWNLOAD_URL "https://llvm-releases.s3.us-east-2.amazonaws.com/clang%2Bllvm-${TINYREFL_LLVM_VERSION}-x86_64-linux-gnu-ubuntu-14.04.tar.xz")
                endif()
            else()
    ...
    if(NOT spdlog_FOUND)
        ...
        message(STATUS "tinyrefl-tool build using spdlog from find_package() module")

        add_library(tinyrefl_externals_spdlog INTERFACE)
        target_link_libraries(tinyrefl_externals_spdlog INTERFACE spdlog::spdlog)
    endif()
endif()
