...
entity_refs<cppast::cpp_member_variable> member_variables(
    const cppast::cpp_entity_index& index, const cppast::cpp_class& class_)
{
    return direct_child_entities<cppast::cpp_member_variable>(
        index, class_, entity_filters::always_true);
}

entity_refs<cppast::cpp_member_function> member_functions(
    const cppast::cpp_entity_index& index, const cppast::cpp_class& class_)
{
    return direct_child_entities<cppast::cpp_member_function>(index, class_);
}

entity_refs<cppast::cpp_constructor> constructors(
    const cppast::cpp_entity_index& index, const cppast::cpp_class& class_)
{
    return direct_child_entities<cppast::cpp_constructor>(index, class_);
}

entity_refs<cppast::cpp_class> member_classes(
    const cppast::cpp_entity_index& index, const cppast::cpp_class& class_)
{
    return direct_child_entities<cppast::cpp_class>(index, class_);
}

entity_refs<cppast::cpp_enum> member_enums(
    const cppast::cpp_entity_index& index, const cppast::cpp_class& class_)
{
    return direct_child_entities<cppast::cpp_enum>(index, class_);
}
