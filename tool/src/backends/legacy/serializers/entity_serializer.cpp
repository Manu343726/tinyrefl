...
#include <tinyrefl/tool/backends/legacy/serializers/entity_serializer.hpp>
    ...
    tinyrefl::tool::class_contents* class_contents_out)
{
    auto
        body =
            [this, &class_](tinyrefl::tool::class_contents& class_contents) -> const std::
                                                                                string& {
                                                                                    if(_entity_registry
                                                                                           .already_registered(
                                                                                               class_))
                                                                                    ...
                                                                                    {
                                                                                        tinyrefl::tool::cppast_backend::
                                                                                            visit_entity(
                                                                                                class_,
                                                                                                cppast::cpp_access_specifier_kind::
                                                                                                    cpp_public,
                                                                                                [this,
                                                                                                 &class_contents](
                                                                                                    const cppast::
                                                                                                 ...
                                                                                                 &class_contents](
                                                                                                    const cppast::
                                                                                                        cpp_member_variable&
                                                                                                            variable) {
                                                                                                    class_contents
                                                                                                        .serialized_member_variables
                                                                                                        .push_back(serialize(
                                                                                                            variable));
                                                                                                },
                                                                                                [this, &class_contents](const cppast::cpp_function& function) {
                                                                                                    class_contents
                                                                                                        .serialized_static_member_functions
                                                                                                        .push_back(serialize(
                                                                                                            function));
                                                                                                },
                                                                                                [this,
                                                                                                 &class_contents](
                                                                                                    const cppast::
                                                                                                        cpp_variable&
                                                                                                            variable) {
                                                                                                    class_contents
                                                                                                        .serialized_static_member_variables
                                                                                                        .push_back(serialize(
                                                                                                            variable));
                                                                                                },
                                                                                                [this,
