#ifndef TINYTREFL_TOOL_BACKENDS_CPPAST_VISITOR_HPP
#define TINYTREFL_TOOL_BACKENDS_CPPAST_VISITOR_HPP
    ...
    Visitors... visitors)
{
    const auto filter = [&root](const cppast::cpp_entity& entity) {
        constexpr tinyrefl::array_view<const cppast::cpp_entity_kind>
            supported_kinds = tinyrefl::typelist_to_array<
                tinyrefl::tool::cppast_backend::cppast_kinds>::value;
    ...
    cppast::visit(
        ...
        [visitors = tinyrefl::overloaded_function_default(visitors...), access](
            ...
            {
                tinyrefl::tool::cppast_backend::entity_cast(entity, visitors);
            }
        });
}
...
#endif // TINYREFL_TOOL_BACKENDS_CPPAST_VISITOR_HPP
