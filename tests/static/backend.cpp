...
using a_member = TINYREFL_MEMBER(TINYREFL_STRING(a), TINYREFL_STRING(Foo::a), TINYREFL_TYPE(Foo, Foo), TINYREFL_VALUE(&Foo::a), TINYREFL_SEQUENCE(()));
using b_member = TINYREFL_MEMBER(TINYREFL_STRING(b), TINYREFL_STRING(Foo::b), TINYREFL_TYPE(Foo, Foo), TINYREFL_VALUE(&Foo::b), TINYREFL_SEQUENCE(()));
...
TINYREFL_REFLECT_MEMBER(TINYREFL_MEMBER(TINYREFL_STRING(c), TINYREFL_STRING(Foo::c), TINYREFL_TYPE(Foo, Foo), TINYREFL_VALUE(&Foo::c), TINYREFL_SEQUENCE(())))
TINYREFL_REFLECT_MEMBER(TINYREFL_MEMBER(TINYREFL_STRING(d), TINYREFL_STRING(Foo::d), TINYREFL_TYPE(Foo, Foo), TINYREFL_VALUE(&Foo::d), TINYREFL_SEQUENCE(())))
