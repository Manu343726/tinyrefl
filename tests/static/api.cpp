...
constexpr auto overload_on_attributes()
    -> tinyrefl::meta::enable_if_t<tinyrefl::has_attribute<T>("return_42"), int>
{
    return 42;
}
...
constexpr auto overload_on_attributes() -> tinyrefl::meta::
    enable_if_t<!tinyrefl::has_attribute<T>("return_42"), int>
{
    return 0;
}
...
EXPECT_EQ(
    (tinyrefl::meta::
         get_t<0, tinyrefl::metadata<my_namespace::MyClass>::constructors>()
             ...
             .namespace_.name()),
    "");
EXPECT_TRUE(tinyrefl::has_attribute<tinyrefl::static_value<
...
EXPECT_TRUE(
    tinyrefl::has_attribute<TINYREFL_STATIC_VALUE(&my_namespace::MyClass::str)>(
        "str"));
EXPECT_EQ(
...
EXPECT_TRUE(tinyrefl::has_attribute<
...
EXPECT_TRUE(
    tinyrefl::has_attribute<my_namespace::MyClass::InnerClassWithMembers>(
