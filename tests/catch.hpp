...
#define INTERNAL_CATCH_TYPE_GEN                                                \
    ...
    {                                                                          \
        using type = typename append<                                          \
            ...
            typename rewrap<TemplateTypeList<Container>, Elements...>::type>:: \
            type;                                                              \
    };                                                                         \
                                                                               \
    template<                                                                  \
    ...
    {                                                                          \
        using type = typename append<                                          \
            Final<>,                                                           \
            typename rewrap<TemplateTypeList<Containers>, Types...>::          \
                type...>::type;                                                \
    };                                                                         \
    template<                                                                  \
        template<typename...>                                                  \
...
#define INTERNAL_CATCH_NTTP_1(signature, ...)                                  \
    ...
    template<                                                                  \
        ...
        typename... Elements>                                                  \
    struct rewrap<                                                             \
        NttpTemplateTypeList<Container>,                                       \
        List<__VA_ARGS__>,                                                     \
        Elements...>                                                           \
    {                                                                          \
        using type = typename append<                                          \
            TypeList<Container<__VA_ARGS__>>,                                  \
            typename rewrap<NttpTemplateTypeList<Container>, Elements...>::    \
                type>::type;                                                   \
    };                                                                         \
    template<                                                                  \
        template<typename...>                                                  \
    ...
    {                                                                          \
        using type = typename append<                                          \
            Final<>,                                                           \
            typename rewrap<NttpTemplateTypeList<Containers>, Types...>::      \
                type...>::type;                                                \
    };
...
inline auto convertInto(
    std::string const& source, CLARA_CONFIG_OPTIONAL_TYPE<T>& target)
    -> ParserResult
{
    T    temp;
    ...
    SourceLineInfo const& _lineInfo)
{
    ...
    TestCaseInfo info(
        static_cast<std::string>(nameAndTags.name),
        _className,
        desc,
        tags,
        _lineInfo);
...
void TrackerBase::close()
{
    ...
    case ExecutingChildren:
        if(std::all_of(
               m_children.begin(), m_children.end(), [](ITrackerPtr const& t) {
                   return t->isComplete();
               }))
            m_runState = CompletedSuccessfully;
        break;
