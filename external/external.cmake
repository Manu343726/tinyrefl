...
if(NOT TARGET tinyrefl_externals_ctti AND
   NOT TARGET tinyrefl_externals_jsonformoderncpp)
    if(NOT TINYREFL_USING_CONAN_TARGETS)
        ...
        if(NOT jsonformoderncpp_FOUND)
            ...
            target_link_libraries(tinyrefl_externals_jsonformoderncpp INTERFACE jsonformoderncpp::jsonformoderncpp)
        endif()
    else()
        add_library(tinyrefl_externals_ctti INTERFACE)
